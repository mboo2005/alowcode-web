...
export const fetchPageList = (params) => {
	return http('post', '/admin/page/getChartList', params)
}

export const fetchPageById = (params) => {
	return http('post', '/admin/page/getChartDetailById', params)
}

export const fetchAddPage = (params) => {
	return http('post', '/admin/page/addChart', params)
}

export const fetchDeletePage = (params) => {
	return http('post', '/admin/page/deleteChart', params)
}

export const fetchUpdatePage = (params) => {
	return http('post', '/admin/page/updateChart', params)
}